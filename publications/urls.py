...
#    path('search/<subject>/', include('haystack.urls')),
    ...
    path('systematic-review/<subject>/browse-by-outcome/<state>', views.browse_by_outcome, name='browse_by_outcome'),
    ...
    re_path('systematic-review/(?P<subject>[a-zA-Z-]+)/effects-by-intervention/(?P<path>.*)', mptt_urls.view(model=Intervention, view=views.effects_by_intervention, slug_field='slug'), name='effects_by_intervention'),
    re_path('systematic-review/(?P<subject>[a-zA-Z-]+)/effects-by-outcome/(?P<path>.*)', mptt_urls.view(model=Outcome, view=views.effects_by_outcome, slug_field='slug'), name='effects_by_outcome'),
